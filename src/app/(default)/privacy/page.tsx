...
export default async function Page() {
  ...
  <>
    ...
    <div className="prose max-w-none">
      ...
      <ul>
        <li>Your name, as entered in the &apos;Name&apos; field.</li>
        <li>Your email address, as entered in the &apos;Email&apos; field.</li>
        <li>Any personal information you enter into the &apos;Message&apos; field.</li>
      </ul>
